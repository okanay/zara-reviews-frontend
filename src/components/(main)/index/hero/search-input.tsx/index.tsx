  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="h-12 w-full appearance-none rounded-md border border-primary-200 bg-white px-9 text-sm outline-none transition-all duration-500 focus:border-primary-500 focus:ring-0"
      />
